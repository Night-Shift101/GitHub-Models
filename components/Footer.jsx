...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    resources: [
      ...
      { name: 'React Documentation', href: 'https://react.dev' },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="xl:col-span-1">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-primary-600 dark:text-primary-400">YP</span>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm max-w-md mb-6">
              A modern Next.js website template with Tailwind CSS, built with industry-standard practices for performance and accessibility.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-sm text-gray-600 dark:text-gray-300 md:mt-0 md:order-1">
              &copy; {currentYear} Your Name. Licensed under{' '}
              <a
